...
<body class="bg-gradient-danger">
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container">
            <a class="navbar-brand text-danger" style="font-weight: 900;" href="login.php"> <img
                    src="assets/img/logo-small.jpg" class="img-fluid" /> PT. PANCA KEMAS KRIDA MANUNGGAL</a>
        </div>
    </nav>
